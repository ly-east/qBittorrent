...
private:
  void updatePeer(int row, const BitTorrent::Torrent *torrent,
                  const BitTorrent::PeerInfo &peer, bool hideZeroValues);
  ...
  QHash<QHostAddress, QSet<QStandardItem *>>
      m_itemsByIP; // must be kept in sync with `m_peerItems`
