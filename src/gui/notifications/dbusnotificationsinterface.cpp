...
DBusNotificationsInterface::DBusNotificationsInterface(
...
QDBusReply<QString> DBusNotificationsInterface::getServerInformation(
...
QDBusPendingReply<uint> DBusNotificationsInterface::notify(
    const QString &appName, const uint id, const QString &icon,
    const QString &summary, const QString &body, const QStringList &actions,
    const QVariantMap &hints, const int timeout) {
  return asyncCall(u"Notify"_s, appName, id, icon, summary, body, actions,
                   hints, timeout);
}

QDBusPendingReply<>
DBusNotificationsInterface::closeNotification(const uint id) {
