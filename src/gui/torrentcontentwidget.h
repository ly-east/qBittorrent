...
public:
  enum Column { Name, Size, Progress, Priority, Remaining, Availability };

  enum class DoubleClickAction { Open, Rename };

  enum class ColumnsVisibilityMode { Editable, Locked };
...
private:
  ...
  // This will trigger sorting and filtering so do it after all relevant data is
  // loaded.
  ...
  ColumnsVisibilityMode m_columnsVisibilityMode =
