...
WatchedFolderOptionsDialog::WatchedFolderOptionsDialog(
    ...
    : QDialog{parent}, m_ui{new Ui::WatchedFolderOptionsDialog},
      m_addTorrentParamsWidget{
          new AddTorrentParamsWidget(watchedFolderOptions.addTorrentParams)},
...
WatchedFolderOptionsDialog::watchedFolderOptions() const {
  ...
  watchedFolderOptions.addTorrentParams =
...
void WatchedFolderOptionsDialog::saveState() { m_storeDialogSize = size(); }
