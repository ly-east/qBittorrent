...
void PowerManagementInhibitor::requestIdle() {
  m_intendedState = Idle;
  if ((m_state == Error) || (m_state == Idle) || (m_state == RequestIdle) ||
      (m_state == RequestBusy))
    return;
  ...
  QDBusMessage call =
      m_useGSM
          ? QDBusMessage::createMethodCall(
                u"org.gnome.SessionManager"_s, u"/org/gnome/SessionManager"_s,
...
void PowerManagementInhibitor::requestBusy() {
  ...
  QDBusMessage call =
      m_useGSM
          ? QDBusMessage::createMethodCall(
                u"org.gnome.SessionManager"_s, u"/org/gnome/SessionManager"_s,
                u"org.gnome.SessionManager"_s, u"Inhibit"_s)
          : QDBusMessage::createMethodCall(
                u"org.freedesktop.PowerManagement"_s,
                u"/org/freedesktop/PowerManagement/Inhibit"_s,
                u"org.freedesktop.PowerManagement.Inhibit"_s, u"Inhibit"_s);
