...
StacktraceDialog::~StacktraceDialog() { delete m_ui; }

void StacktraceDialog::setText(const QString &signalName,
                               const QString &stacktrace) {
  // try not to call signal-unsafe functions

  const QString htmlStr =
      QStringLiteral("<p align=center><b><font size=7 color=red>"
                     "qBittorrent has crashed"
                     "</font></b></p>"
                     "<font size=4><p>"
                     "Please file a bug report at "
                     "<a "
                     "href=\"https://bugs.qbittorrent.org\">https://"
                     "bugs.qbittorrent.org</a> "
          ...
          .arg(QString::number(QT_POINTER_SIZE * 8),
               ...
               Utils::Misc::zlibVersionString(), Utils::Misc::osName(),
