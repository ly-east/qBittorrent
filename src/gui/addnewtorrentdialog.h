...
public:
  ...
  static void show(const QString &source,
...
private:
  ...
  explicit AddNewTorrentDialog(const BitTorrent::AddTorrentParams &inParams,
                               QWidget *parent);
  ...
  void loadState();
  void saveState();
  void setMetadataProgressIndicator(bool visibleIndicator,
